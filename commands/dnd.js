    ...
    if (subCommand === 'oyna' || subCommand === 'play' || subCommand === 'tema_sec') {
      ...
      try {
        const systemInstruction = [
          ...
          '   - Eğer oyuncu eyleminde açıkça zar atmak istediğini belirtiyorsa, bir konuda kapışmak/karar vermek için zar atılmasını teklif ediyorsa (Örn: "kahvaltı hazırlamak için zar atma kararı kıldık", "el çabukluğu zarı atıyorum", "zar atıp belirleyelim") DM KESİNLİKLE talep edilen zarları istemek zorundadır.',
